...
class Restaurante {
    ...
    public static Restaurante parseRestaurante(String s) {
        String[] campos = TextoQ01.separar(s, ',');
        int id = TextoQ01.paraInt(campos[0]);
        String nome = campos[1];
        String cidade = campos[2];
        int capacidade = TextoQ01.paraInt(campos[3]);
        double avaliacao = TextoQ01.paraDouble(campos[4]);
        String[] tiposCozinha = TextoQ01.separar(campos[5], ';');
        int faixaPreco = campos[6].length();

        String horario = campos[7];
        int dashPos = TextoQ01.posChar(horario, '-');
        Hora horarioAbertura = Hora.parseHora(TextoQ01.faixa(horario, 0, dashPos));
        Hora horarioFechamento = Hora.parseHora(TextoQ01.faixa(horario, dashPos + 1, horario.length()));

        Data dataAbertura = Data.parseData(campos[8]);
        boolean aberto = TextoQ01.igual(campos[9], "true");
